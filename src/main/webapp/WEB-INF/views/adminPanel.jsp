            ...
            <ul class="nav navbar-top-links navbar-right">
                <li class="dropdown"><a class="dropdown-toggle count-info" data-toggle="dropdown" href="#">
                    ...
                    <ul class="dropdown-menu dropdown-messages">
                        <li>
                            <div class="dropdown-messages-box"><a href="${contextPath}/resources/assets/profile.html" class="pull-left">
...
<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
    ...
    <ul class="nav menu">
        <li><a href="${contextPath}/jsDonut/admin/product"><em class="fa fa-dashboard">&nbsp;</em> Products</a></li>
        <li><a href="${contextPath}/jsDonut/admin/sprinkle"><em class="fa fa-dashboard">&nbsp;</em> Sprinkles</a></li>
        <li><a href="${contextPath}/jsDonut/admin/dough"><em class="fa fa-calendar">&nbsp;</em> Doughs</a></li>
        <li><a href="${contextPath}/jsDonut/admin/filling"><em class="fa fa-calendar">&nbsp;</em> Fillings</a></li>
...
<script src="${contextPath}/resources/assets/js/jquery-1.11.1.min.js"></script>
<script src="${contextPath}/resources/assets/js/bootstrap.min.js"></script>
<script src="${contextPath}/resources/assets/js/chart.min.js"></script>
<script src="${contextPath}/resources/assets/js/chart-data.js"></script>
<script src="${contextPath}/resources/assets/js/easypiechart.js"></script>
<script src="${contextPath}/resources/assets/js/easypiechart-data.js"></script>
<script src="${contextPath}/resources/assets/js/bootstrap-datepicker.js"></script>
