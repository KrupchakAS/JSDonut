...
<script type="text/javascript" src="${contextPath}/resources/assets/js/jsData/sendAjax.js"></script>
...
<script type="text/javascript" src="${contextPath}/resources/assets/js/datatables.js"></script>
